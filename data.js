...
window.HammerSeed = function () {
  ...
  const sources=[
    {id:1,source_code:'TOKYO_STUDIO',provider:'website',url:'https://example.com/tokyo/auditions',country:'Japan',city:'Tokyo',priority:1,enabled:true,crawl_status:'success',last_http_status:200,notes:'Public audition listings'},
    {id:2,source_code:'SG_DANCE',provider:'website',url:'https://example.org/sg/jobs',country:'Singapore',city:'Singapore',priority:2,enabled:true,crawl_status:'failed',last_http_status:503,error_message:'Source temporarily unavailable',notes:'Retry after the source recovers'},
    {id:3,source_code:'OSAKA_STAGE',provider:'website',url:'https://example.net/osaka/casting',country:'Japan',city:'Osaka',priority:3,enabled:false,crawl_status:'skipped',last_http_status:null,notes:'Paused by administrator'}
  ...
  const data={version:3,dancers:[dancer,{...dancer,id:2395,email:'ken@example.com',city:'Osaka'}],ai_source_links:sources,ai_opportunities:opportunities,
...
function expandDemo(d,date){
  ...
  ].map(([id,source_code,url,city,enabled,crawl_status])=>({id,source_code,url,normalized_url:url,city,country:city==='Singapore'?'Singapore':'Japan',enabled,crawl_status,provider:id===6?'community':'website',priority:id-1,notes:'Synthetic review scenario',last_http_status:null,last_crawled_at:null,next_crawl_at:null,crawl_count:0,failed_count:0,unchanged_count:0,error_message:null})));
  const variants=[
